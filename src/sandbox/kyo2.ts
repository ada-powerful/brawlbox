// Full 36-action Kyo, built from the pre-baked atlas (kyo2-atlas.png) + frame
// data (kyo2-data.json) generated offline from the magenta/green reference
...
import kyo2Data from './kyo2-data.json' with { type: 'json' };
import kyo2AtlasUrl from './kyo2-atlas.png';
...
const data = kyo2Data as unknown as {
...
export const KYO2_ATLAS_URL: string = kyo2AtlasUrl;
...
export const KYO2_CHARACTER: Character = parseCharacter({
  meta: { id: 'kyo2', name: 'Kyo (full 36-action sheet)', author: 'BrawlBox', version: '0.1.0' },
  data: {
    life: 1000,
    attack: 100,
    defence: 100,
  ...
  spriteAtlas: { url: 'kyo2/atlas.png', frames: data.frames },
});
